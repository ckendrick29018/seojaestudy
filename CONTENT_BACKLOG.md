...
| 122 | The Story of the Three Bears | Joseph Jacobs (1890) | 7439 | A1 | whole (simplified retelling, 17 sentences; a fourth tale from the same collection as Henny-Penny, The Three Little Pigs, and The Old Woman and Her Pig — a little old woman lets herself into the bears' house, tries each bowl of porridge, chair, and bed until she finds the smallest one "just right," then wakes to find the three bears staring down at her and flees into the wood; already genuinely gentle, the source's own vaguer, darker guesses about her fate left out) — a fourth English/American nursery tale, continuing the run flagged in "Good next lessons to build" | ☑ |
...
- **Live now (168 — 135 classics + 24 folktales + 8 biographies; plus 5
  ...
  **The Time Machine** (B2, classics) — H. G. Wells's 1895 novel
  ...
  one "just right," then wakes to the three bears staring down at her
  and flees into the wood; already genuinely gentle, continuing the
  run of English/American nursery tales flagged in "Good next lessons
  to build"; and **Xingu** (B2, classics) — Edith Wharton's 1916 short
  story (PG#24131), an eighth Wharton pick and a change of tone: a
  pretentious ladies' Lunch Club bluffs its way through a conversation
  about "Xingu," a word one member invents on the spot to rescue an
  awkward silence, only to discover after their celebrated guest
  leaves that Xingu is simply a river in Brazil — a comedy of
  pretension rather than a somber opening chapter, the "eighth
  Wharton" option flagged in "Good next lessons to build."
  Before that, an earlier batch the same day
  ...
  **Tess of the d'Urbervilles** (B2, classics) — Chapter 1 of Thomas
  ...
  all, just a curse turned into a hundred-year sleep and a kiss that
  wakes the whole castle); and **Dracula** (B2, classics) — the opening
  chapter of Bram Stoker's novel, Jonathan Harker's journal of his
  journey to Bistritz, the innkeeper's wife's terrified warning about St.
  George's Eve, and the villagers' old charm against the evil eye as his
  coach departs for the Borgo Pass (PG#345) — a fresh B2 author, the
  first genuinely new one since Stevenson last round. Before that, an
  earlier batch the same day (third round): **Rumpelstiltskin**
  ...
  uncovers the truth (PG#2591, same collection as the shelf's other Grimm
  picks; the tale's violent ending — Falada's beheading and the impostor's
  execution — is dropped for a gentler resolution where she is simply sent
  away); and **Far from the Madding Crowd** (B2, classics) — the opening
  scene of Thomas Hardy's novel, farmer Gabriel Oak watching a vain young
  woman admire her own reflection from a passing wagon, then paying her
  toll himself only to be ignored — an entirely fresh author for the B2
  shelf (PG#27). Before that, an earlier batch the same day: **The
  Fisherman and His Wife** (A1, classics) — the Brothers Grimm tale of the
  magic flounder and the wife whose wishes grow from a cottage to a castle
  to ruling the sun and moon, ending back where they started (PG#2591,
  same collection as the shelf's other Grimm picks); and **Amos Barton**
  (B2, classics) — the opening of George Eliot's "The Sad Fortunes of the
  Reverend Amos Barton" from Scenes of Clerical Life (PG#17780, her second
  pick on the shelf after The Lifted Veil), the narrator's plea for
  sympathy toward an unremarkable curate and his devoted wife Milly.
  Before that, an earlier batch the same day: four new lessons directly
  fulfilling two "Good next
...
- Good next lessons to build — four bands now sit at 19–27; pick by fit:
  - B2: **The Lifted Veil** (George Eliot), **Summer** (Edith Wharton,
    ...
    **The Legend of Sleepy Hollow** (Washington Irving — an entirely
    ...
    is live too, and now **Xingu** (Edith Wharton — an eighth Wharton
  ...
  - A1 (keep diversifying away from Potter): **Mother Holle**, **The
    ...
    **The Fisherman and His Wife** (the flounder and the wife's
    ...
    finally set in motion by a bowl of milk) is live too, and now **The
