...
export const dict = {
  ...
  // Multi-chapter books. `{n}` / `{total}` / `{done}` are filled in by the caller.
  continueReadingTitle: { en: "Continue reading", ko: "이어서 읽기" },
  continueResume: { en: "Continue", ko: "계속 읽기" },
  continueUpNext: { en: "Up next", ko: "다음 이야기" },
  bookPartOf: { en: "Part {n} of {total}", ko: "{total}편 중 {n}편" },
  bookPartN: { en: "Part {n}", ko: "{n}편" },
  bookPartsCount: { en: "{n} parts", ko: "총 {n}편" },
  bookProgress: { en: "{done} of {total} read", ko: "{total}편 중 {done}편 읽음" },
  bookInThisBook: { en: "In this book", ko: "이 책의 이야기" },
  bookReadNext: { en: "Read the next part", ko: "다음 편 읽기" },
  bookStartReading: { en: "Start reading", ko: "읽기 시작하기" },
  bookContinueWithPart: { en: "Continue with part {n}", ko: "{n}편 이어서 읽기" },
  bookMoreComing: {
    en: "That's every part we have so far. More chapters are on the way.",
    ko: "지금까지 준비된 이야기를 모두 읽었어요. 새로운 챕터가 곧 추가돼요.",
  },
  bookAllRead: { en: "You've read every part — well done!", ko: "모든 편을 다 읽었어요 — 잘했어요!" },
  bookBackToBook: { en: "About this book", ko: "책 소개" },
